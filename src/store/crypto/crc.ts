...
export const crcStateSchema = z.object({
  ...
  poly: z.string().min(3, 'Введите корректное 16-ричное число'),
  init: z.string().min(3, 'Введите корректное 16-ричное число'),
...
export const { setCrc: setAdc } = crcSlice.actions;
